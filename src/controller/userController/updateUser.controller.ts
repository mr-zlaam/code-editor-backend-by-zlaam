...
class UpdateUserController {
  ...
  public updateBasicInfo = asyncHandler(async (req: _Request, res) => {
    ...
    await this._userUpdateService.updateBasicUserInformationService(
  ...
  public updateUserEmail = asyncHandler(async (req: _Request, res) => {
    ...
    const updatedUser = await this._userUpdateService.updateUserEmailService(
      email,
      uid,
    );
  ...
  public updateUserPassword = asyncHandler(async (req: _Request, res) => {
    ...
    await this._userUpdateService.updateUserPasswordService(
      uid,
      newPassword,
      res,
    );
  ...
  public forgotPasswordRequestFromUser = asyncHandler(
...
export const updateUserController = (db: DatabaseClient) =>
  new UpdateUserController(db);
